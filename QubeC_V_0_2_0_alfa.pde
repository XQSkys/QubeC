...
if(get(mouseX,mouseY)==ship1){sap=1;shrink++;pop=1;}else {sap=0;shrink--;beanx=1;pop=0;}
    strokeWeight(4);
       stroke(0,0,255);
    translate(20, 20,20);
  line (0, 0,  mx1, my1);  
  ...
  if (mousePressed && (mouseButton == RIGHT)) {
   if(get(mouseX,mouseY)==ship2) {sap=1;shrink++;pop=1;}else {sap=0;shrink--;beanx=1;pop=0;}
