...
public class QubeC_V_0_2_1_3_Alfa extends PApplet {
...
movet=1;
  ...
  if(movet==1){
   ...
   rdmp=(int)random(-3,3);
     rdmps=rdmps+ (int)random(-score2,score2)/3;
     rndpb3=0;
    
        rdmp1=(int)random(-3,3);
  rdmps1=rdmps1+ (int)random(-score2,score2)/3;
     rndpb3=0;
     
       rdmp2=(int)random(-3,3);
      rdmps2=rdmps2+ (int)random(-score2,score2)/3;
     rndpb3=0;
      rdmp3=(int)random(-3,3);
      rdmps3=rdmps3+ (int)random(-score2,score2)/3;
...
sap=0;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "QubeC_V_0_2_1_3_Alfa" };
    if (passedArgs != null) {
