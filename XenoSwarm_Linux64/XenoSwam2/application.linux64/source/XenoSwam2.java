...
public class XenoSwam2 extends PApplet {
...
if(ehit<=0){movet=0;ehit=7;}else movet=1;
...
if(Waste==2){Chargo=Chargo-(int)random(0,2);}
if(Chargo<=45){if(Waste==2)Traktor=Traktor-(int)random(0,2);}
...
switch(num2) {
  ...
  benemyx=(int)random(100,200);
  benemyy=(int)random(100,200)+200;
  benemyy2=(int)random(100,200) +200-shrink;
  benemyx2=(int)random(100,200) +200-shrink;
   fill(ship1);
    rect(benemyx,benemyy ,benemyx2, benemyy2);  // Black rectangle
shipm1=(ship1);
...
break;
  ...
  benemyx=(int)random(100,200)+200;
  benemyy=(int)random(100,200);
  benemyy2=(int)random(100,200) +200-shrink;
  benemyx2=(int)random(100,200) +200-shrink;
   fill(ship1);
    rect(benemyx,benemyy ,benemyx2, benemyy2);  // Black rectangle
...
if(movet==1){
   ...
   rdmp=(int)random(-3,3);
     rdmps=rdmps+ ((int)random(- (int)sqrt(score2*abs((int)sqrt((int)random(-1*abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4))))*2),abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))/1))*level)))) , (int)sqrt(score2*abs((int)sqrt((int)random(-1*abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))))*2,abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))))*level)))))/1)*rdmp;
  rndpb3=0;
    
        rdmp1=(int)random(-3,3);
  rdmps1=rdmps1+((int)random(- (int)sqrt(score2*abs((int)sqrt((int)random(-1*abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(benemyx+benemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4))))*2),abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))/1))*level)))) , (int)sqrt(score2*abs((int)sqrt((int)random(-1*abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))))*2,abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))))*level)))))/1)*rdmp;
  rndpb3=0;
     rndpb3=0;
     
       rdmp2=(int)random(-3,3);
      rdmps2=rdmps2+((int)random(- (int)sqrt(score2*abs((int)sqrt((int)random(-1*abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4))))*2),abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))/1))*level)))) , (int)sqrt(score2*abs((int)sqrt((int)random(-1*abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))))*2,abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))))*level)))))/1)*rdmp;
  rdmp3=(int)random(-3,3);
      rdmps3=rdmps3+ ((int)random(- (int)sqrt(score2*abs((int)sqrt((int)random(-1*abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4))))*2),abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))/1))*level)))) , (int)sqrt(score2*abs((int)sqrt((int)random(-1*abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))))*2,abs((((abs((benemyx+benemyx2)/2-(int)mouseoverx1-(enemyx+enemyx2)/4)+abs((enemyy+enemyy2)/2-(int)mouseovery1-(benemyy+benemyy2)/4)))))*level)))))/1)*rdmp;
  rndpb3=0;
     rndpb3=0;
...
if(enemyy<=20){enemyy3++;enemyy3++;rdmps1=0;}
 ...
 if((enemyy2)<=50){enemyy2++;enemyy2++;rdmps3=0;}
  ...
  if((enemyx2)>=700){enemyx2--;enemyx2--;rdmps2=0;}
 
 if((enemyy2)>=700){enemyy2--;enemyy2--;rdmps3=0;}

    if(abs(enemyx)<100){if(abs(enemyy)<160)  {ammo--; if(ammo<=0){shrink--;}}}
...
stroke(shipm);
 ...
 if(benemyx<=150+ammo){benemyx3++;benemyx3++; brdmps=0;}
 
 if(benemyy>=500-ammo){benemyy3--;benemyy3--;brdmps1=0;}
 
  if(benemyx>=500-ammo){benemyx3--;benemyx3--;brdmps=0;}
 
if(benemyy<=150+ammo){benemyy3++;benemyy3++;brdmps1=0;}


 
  if(benemyx<=120){benemyx3++;benemyx3++;brdmps=0;}
 
 if(benemyy+benemyy2>=600){benemyy3--;benemyy3--;brdmps1=0;}
 
  if(benemyx+benemyx2>=600){benemyx3--;benemyx3--;brdmps=0;}
 
if(benemyy<=120){benemyy3++;benemyy3++;brdmps1=0;}
 
   
  if((benemyx2)<=50){benemyx2++;benemyx2++;brdmps2=0;}
 
 if((benemyy2)<=50){benemyy2++;benemyy2++;brdmps3=0;}
 
  if((benemyx2)>=300){benemyx2--;benemyx2--;brdmps2=0;}
 
 if((benemyy2)>=300){benemyy2--;benemyy2--;brdmps3=0;}

    if(abs(benemyx)<100){if(abs(benemyy)<160)  {ammo--; if(ammo<=0){shrink--;}}}
...
sap=0;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "XenoSwam2" };
    if (passedArgs != null) {
